...
export class ExpenseBackendServices extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps){
        ...
        // assests  is used to build the docker image from the local directory and push it to ECR( Elastic Container Registry). we are using this because we want to build the image locally and push it to ECR so that we can use it in our ECS service.
